...
$sql = "INSERT INTO users (`username`, `email`, `password`, `activation`) VALUES ('$username', '$email', '$password','activated')";
$result = mysqli_query($link, $sql);
if(!$result){
...
$message .="mihiraswal.host20.uk/QuickRide/activate.php?email=".urlencode($email).
"&key=$activationKey";
$headers="Content-type: text/html";
if(mail($email, "Confirm your Registration", $message,$headers)){
//       echo "<div class='alert alert-success'>Thank for your registring! A confirmation email has been sent to $email. Please click on the activation link to activate your account.</div>";
      echo "<div class='alert alert-success'>Your account hase been activated. Now U can login to your account.</div>";
